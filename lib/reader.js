  ...
  parseRow: {
    value: function parseRow(events, start, end) {
      ...
      while (i <= end) {
        ...
        // jshint -W080
        // I'm setting to undefined to emphasize we need this value.  Earlier
        // had a bug where we didn't do that and had "var" instead of "let" so
        // the value from one column was used for the next.
        ...
        // leaving undefined in `cols`.  This also ensures that the row is only
        // as long as necessary to hold the last non-undefined value.
